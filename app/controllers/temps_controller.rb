class TempsController < ApplicationController
  def index
    ...
    @current_temp = @temps['query']['results']['channel']['item']['condition']['temp']
    
    @forecast = @temps['query']['results']['channel']['item']['forecast']
    
    @city_name = @temps['query']['results']['channel']['location']['city']
  end 
end
